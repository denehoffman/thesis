...
\begin{table}
  \begin{center}
    ...
    \end{tabular}
    \caption{Summary of total luminosity and total luminosity in the coherent peak for each run period. Note that these values include runs with an amorphous radiator, see \Cref{fig:tagged-luminosity} for the luminosity of only polarized beam runs.}\label{tab:run-info}
  \end{center}
\end{table}
