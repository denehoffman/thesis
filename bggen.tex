...
\begin{figure}
  \begin{center}
    \includesvg[width=0.8\textwidth]{ext/analysis/plots/chisqdof_large_bggen_None.svg}
  \end{center}
...
\begin{figure}
  \begin{center}
    \includesvg[width=0.8\textwidth]{ext/analysis/plots/me_bggen_None.svg}
  \end{center}
...
\begin{figure}
  \begin{center}
    \includesvg[width=0.8\textwidth]{ext/analysis/plots/me_combined_None_None_None.svg}
  \end{center}
