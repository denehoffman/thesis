...
\begin{figure}
    ...
    \begin{subfigure}{0.45\textwidth}
        ...
        \caption{Data}
    \end{subfigure}
    \caption{The energy loss in the FDC for pions after all fiducial cuts are applied. Note that the discrepancy between data and Monte Carlo here is due to differences in calibration of the FDC in some of the earlier data runs and can be ignored for this analysis.}\label{fig:dedx-v-p-fdc-pions-pz-masscut-chisqdof-3.0-mesons}
\end{figure}
