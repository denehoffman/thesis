...
\appendix
\chapter{Derivation of the Chew-Mandelstam Function}\label{appendix:chew-mandelstam}
\input{chew-mandelstam.tex}
\chapter{Relation between the Width of a Breit-Wigner and the Resonance Lifetime}\label{appendix:breit-wigner}
\input{cauchy.tex}
